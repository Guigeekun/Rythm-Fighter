//Difficulté normale; 1: difficile 2: normal, 4: easy (pour un futur menu de selection.)
var difficulty = 2;
...
var songs = [{title:"Judgement Star", pathMp3:'/audio/song/minami-JudgementStar.mp3', pathOgg:'/audio/song/minami-JudgementStar.ogg', tempo:1/(190/60)*difficulty}];
...
function preload() {
   ...
   text = game.add.text(gameWidth/3, gameHeight/2, 'Loading...', { fill: '#ffffff' });
...
function startGame(){
  music.play();
  game.time.events.loop(Phaser.Timer.SECOND*songs[0].tempo, beatLoop, this);
}
